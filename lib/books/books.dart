...
class _BookShelfPageState extends State<BookShelfPage> {
  ...
  Widget build(BuildContext context) {
    final List<Book> books = [
      Book(
          coverAsset: 'assets/books_anim/1_stoic.png',
          spineAsset: 'assets/books_anim/1_stoic_spine.png',
          isOpen: false),
      Book(
          coverAsset: 'assets/books_anim/2_moon.png',
          spineAsset: 'assets/books_anim/2_moon_spine.png',
          isOpen: false),
      Book(
          coverAsset: 'assets/books_anim/3_dog.png',
          spineAsset: 'assets/books_anim/3_dog_spine.png',
          isOpen: false),
      Book(
          coverAsset: 'assets/books_anim/4_bird.png',
          spineAsset: 'assets/books_anim/4_bird_spine.png',
          isOpen: false),
      Book(
          coverAsset: 'assets/books_anim/1_stoic.png',
          spineAsset: 'assets/books_anim/1_stoic_spine.png',
